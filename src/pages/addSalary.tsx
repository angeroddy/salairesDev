...
export default function AddSalary() {
    ...
    useEffect(() => {
        document.body.classList.add('bg-gray-100'); // ou 'bg-[#FAFAFB]', etc.
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                    ...
                    <Controller
                        name="poste"
                        control={control}
                        render={({ field }) => <Select {...field} options={postesOptions} />}
                        rules={{ required: true }}
                    />
                </div>
                ...
                <div>
                    ...
                    <Controller
                        name="localisation"
                        control={control}
                        render={({ field }) => <Select {...field} options={villesOptions} />}
                        rules={{ required: true }}
                    />
                </div>
                ...
                <div>
                    ...
                    <Controller
                        name="niveau"
                        control={control}
                        render={({ field }) => <Select {...field} options={niveaux} />}
                    />
                </div>
                ...
                <div>
                    ...
                    <Controller
                        name="modalite_travail"
                        control={control}
                        render={({ field }) => <Select {...field} options={modalites} />}
                    />
                </div>
                ...
                <div className="flex gap-4">
                    <div className="flex-1">
                        ...
                        <input
                            type="number"
                            {...register('exp_entreprise', { required: true })}
                            className="w-full border px-3 py-2 rounded"
                        />
                    </div>
                    ...
                    <div className="flex-1">
                        ...
                        <input
                            type="number"
                            {...register('exp_totale', { required: true })}
                            className="w-full border px-3 py-2 rounded"
                        />
                    </div>
                </div>
